...
public class ContactHostByEmail {

	public static void main(String[] args) throws AddressException, MessagingException {

//		contactHostByEmail("jagtarsinghtandon@gmail.com");
//
	}

	public static void contactHostByEmail() {
		...
		Session session = Session.getDefaultInstance(properties, new Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("aupairsystem@gmail.com", "Pass123$$");
			}
		}
		);
		try {
			...
			messageBodyPart.setText("****** THIS IS A SYSTEM GENERATED EMAIL . PLEASE DO NOT REPLY. ******"
					+ "\n An AUPAIR wants to connect with you, plesae login to your profie to view details \n Thank you");
