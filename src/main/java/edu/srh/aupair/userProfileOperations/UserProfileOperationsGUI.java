...
import edu.srh.aupair.utilities.ContactHostByEmail;
...
public class UserProfileOperationsGUI {
	...
	public void mainMenu(int person_Id) throws SQLException {
		...
		if (userInput == 1) {
			...
			searchByPreference(sc, person_Id);
		} else if (userInput == 3) {
			deleteSelfProfile(sc);
		} else if (userInput == 4) {
			viewProposals(sc, person_Id);
		} else if (userInput == 5) {
			logout(sc);
		}
	}
	...
	public void viewProposals(Scanner sc,int personId ) throws SQLException {
	...
	public void searchByPreference(Scanner sc, int person_id) throws SQLException {
		...
		printSearch(personId, firstName, lastName, contactNo, gender, maritalStatus, dob, isActive, addressLine1, city, postcode, 
				...
				qualification, hostId, aboutMe, preferredLanguage, ratings, PERSON_TYPE, numberOfKids, ageOfKids, 
				hasPyhsicalDisability, salaryProvided, count);
		
		int personIdContacted =0;
		contactHost(personIdContacted , PERSON_TYPE, gender, qualification, country, city, preferredLanguage, 
	...
	public void contactHost(int personIdContacted, String PERSON_TYPE, String gender, String qualification,
			String country, String city, String preferredLanguage, int ratings, int personId,
		...
		if (loggedInPersonType == "AUPAIR") {
			...
			if (contactYesOrNo == 'y' || contactYesOrNo == 'Y') {
				...
				ResultSet result = serviceObject.searchByPreference(personIdContacted, PERSON_TYPE, gender,
						qualification, country, city,preferredLanguage, ratings);
				...
				ContactHostByEmail.contactHostByEmail();
				...
				printSearch(personId, firstName, lastName, contactNo, gender, maritalStatus, dob, isActive,
						...
						aboutMe, preferredLanguage, ratings, PERSON_TYPE, numberOfKids, ageOfKids,
						hasPyhsicalDisability, salaryProvided, count);

				contactHost(personIdContacted, PERSON_TYPE, gender, qualification, country, city,
	...
	public void printSearch(int personId, String firstName, String lastName, String contactNo, String gender,
			...
			String PERSON_TYPE, int numberOfKids, int ageOfKids, boolean hasPyhsicalDisability,
		...
		if (count == 0) {
			...
			searchByPreference(sc,personId);
		}
	}
